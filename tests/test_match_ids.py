...
class TestGetMatchIdsByPuuid:
    ...
    async def test_get_match_ids_by_puuid_basic(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_with_count(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_with_queue_filter(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_with_raw_queue_id(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_with_match_type(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_with_raw_match_type(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_count_validation(self, client, test_puuid):
    ...
    async def test_get_match_ids_by_puuid_pagination(self, client, test_puuid):
