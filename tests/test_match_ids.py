...
class TestGetMatchIdsByPuuid:
    ...
    @pytest.fixture
    def test_puuid(self, client) -> str:
    ...
    async def test_get_match_ids_by_puuid_basic(self, client, test_puuid) -> None:
    ...
    async def test_get_match_ids_by_puuid_with_count(self, client, test_puuid) -> None:
    ...
    async def test_get_match_ids_by_puuid_with_queue_filter(self, client, test_puuid) -> None:
        """Test get_match_ids_by_puuid with queue filter."""
        # Test with ARAM queue
        result = await client.get_match_ids_by_puuid(test_puuid, queue=QueueId.ARAM, count=5)
    ...
    async def test_get_match_ids_by_puuid_with_raw_queue_id(self, client, test_puuid) -> None:
    ...
    async def test_get_match_ids_by_puuid_with_match_type(self, client, test_puuid) -> None:
    ...
    async def test_get_match_ids_by_puuid_with_raw_match_type(self, client, test_puuid) -> None:
    ...
    async def test_get_match_ids_by_puuid_count_validation(self, client, test_puuid) -> None:
    ...
    async def test_get_match_ids_by_puuid_pagination(self, client, test_puuid) -> None:
