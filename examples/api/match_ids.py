...
page_1 = client.get_match_ids_by_puuid(puuid, start=0, count=5)
page_2 = client.get_match_ids_by_puuid(puuid, start=5, count=5)
page_3 = client.get_match_ids_by_puuid(puuid, start=10, count=5)
...
print("  player.get_recent_matches(count=20, queue=QueueId.RANKED_SOLO_5x5)")
