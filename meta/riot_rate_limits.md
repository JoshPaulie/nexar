<!-- The following was copied from the docs and manually formatted to md for ref -->
# Web APIs
...
This error indicates that the server has not found anything matching the request URI. The client should not continue to make similar requests without modifying the parameters of the request.
