...
- [GET /lol/summoner/v4/summoners/by-name/{summonerName}](apis.md#league-of-legends-core-endpoints) - deprecated
...
- (ACCOUNT-V1) [GET /riot/account/v1/accounts/by-riot-id/{gameName}/{tagLine}](apis.md#account-v1-core-endpoints) - obtain PUUID from Riot ID.
- (SUMMONER-V4) [GET /lol/summoner/v4/summoners/by-puuid/{encryptedPUUID}](apis.md#league-of-legends-core-endpoints) - retrieve summoner data by PUUID.
...
- (ACCOUNT-V1) [GET /riot/account/v1/accounts/by-puuid/{puuid}](apis.md#account-v1-core-endpoints) - fetch Riot ID data by PUUID.
...
- (SUMMONER-V4) [GET /lol/summoner/v4/summoners/{encryptedSummonerId}](apis.md#league-of-legends-core-endpoints) - use summonerID to retrieve summoner data, then PUUID.
...
Check our [FAQ](summoner-name-to-riot-id-faq.md) for more details.
...
Before you can get started with RSO, you will need a production key. If you do not have one, create one via the Developer Portal.

## Implementing RSO

RSO - [Client Secret Basic](rso-client-secret-basic.md) - [Private Key JWT](rso-private-key-jwt.md)

Sample RSO Node App: [rso-example-app.md](rso-example-app.md)
...
After logging in, players are redirected back to the redirect\_uri you specified. See [Implementing Riot Sign On](rso-private-key-jwt.md) and [Example RSO Node App](rso-example-app.md) for information about how to integrate with RSO and to view a sample Node web server that implements the example.

Your RSO client has access to endpoints that will allow you to identify who logged in.

For League of Legends, you will use [GET /riot/account/v1/accounts/me](apis.md#account-v1-core-endpoints):
...
**Latest**  
[https://ddragon.leagueoflegends.com/cdn/ **dragontail-16.10.1.tgz**](https://ddragon.leagueoflegends.com/cdn/dragontail-16.10.1.tgz)
...
The data file URLs include both a version and language code. The examples in the documentation below use version `16.10.1` and the `en_US` language code. If you want to view assets released in other versions or languages, replace the version or language code in the URL.
...
[https://ddragon.leagueoflegends.com/cdn/ **languages.json**](https://ddragon.leagueoflegends.com/cdn/languages.json)
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en\_US/ **champion.json**](https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en_US/champion.json)  
[https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en\_US/champion/ **Aatrox.json**](https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en_US/champion/Aatrox.json)
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/champion/ **Aatrox**.png](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/champion/Aatrox.png)

### Champion Passive Assets

[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/passive/ **Anivia\_P**.png](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/passive/Anivia_P.png)
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/spell/ **FlashFrost.png**](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/spell/FlashFrost.png)
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en\_US/ **item.json**](https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en_US/item.json)
...
A list of possible stats that you gain from items, runes, or masteries can also be found in [Data Dragon](https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en_US/item.json). You can find a list of stats gained by the item, rune, or mastery by searching for the `stats` field. Below are some tips when it comes to understanding what a stat means and how they are calculated:
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/item/ **1001**.png](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/item/1001.png)  
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en\_US/ **summoner.json**](https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en_US/summoner.json)  
[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/spell/ **SummonerFlash**.png](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/spell/SummonerFlash.png)

### Profile Icons

[https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en\_US/ **profileicon.json**](https://ddragon.leagueoflegends.com/cdn/16.10.1/data/en_US/profileicon.json)  
[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/profileicon/ **685**.png](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/profileicon/588.png)
...
[https://ddragon.leagueoflegends.com/cdn/16.10.1/img/sprite/ **spell0**.png](https://ddragon.leagueoflegends.com/cdn/16.10.1/img/sprite/spell0.png)
...
Access to the Tournaments API provides several new methods that can be viewed on the [API reference](apis.md). You should explore every method to get more information on actual usage including the format and description of parameters you can supply.
...
In addition to game stats related methods, the [lobby-events/by-code/{tournamentCode}](api-methods.md#league-tournaments-api-methods) method can help query pre-game lobby events. This is useful for building tournament administration systems and detecting whether a game for a given tournament code started normally. This call can be made both after the match for the full timeline and anytime during the lobby phase for a timeline of events up to that moment. Below is an example of the JSON returned for lobby events:
...
You can find a sample response in [liveclientdata_sample.md](liveclientdata_sample.md).
...
You can find a list of sample events in [liveclientdata_events.md](liveclientdata_events.md).
...
Season IDs are used in match history to indicate which season a match was played. A full list of season ids can be found in [seasons.md](seasons.md).
...
Queue IDs show up in several places throughout the API and are used to indicate which kind of match was played. A full list of queue ids can be found in [queues.md](queues.md).
...
Map IDs are used in match history to indicate which map a match was played. A full list of map IDs can be found in [maps.md](maps.md).
...
A full list of game modes can be found in [gameModes.md](gameModes.md).
...
A full list of game types can be found in [gameTypes.md](gameTypes.md).
