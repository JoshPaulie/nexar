...
[![Generated by Deepseek](https://custom-icon-badges.demolab.com/badge/Generated%20by%20Deepseek-4D6BFF?logo=deepseek&logoColor=fff)](#)
...
```
 rate_limiter.acquire(region="na1", method="league-v4")
   ...
   |     |     +--- NO  ------------> sleep(longest of block_wait or refill_wait),
