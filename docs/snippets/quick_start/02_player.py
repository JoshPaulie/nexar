...
if riot_api is None:
    # Set dummy key for doc generation/testing if not provided
    riot_api = "RGAPI-DUMMY-KEY-FOR-DOCS"
    # In real usage, you'd exit: sys.exit("Couldn't find RIOT_API_KEY.")
...
async def main() -> None:
    # In a real scenario without a valid key, these calls would fail with 403.
    # Defining the code paths for documentation.
